...
# STEP 2
c.execute("INSERT INTO employee1s VALUES (01,'Sylvester', 'Fernandes', 50000)")
c.execute("INSERT INTO employee1s VALUES (02,'Yogendra', 'Singh', 70000)")
c.execute("INSERT INTO employee1s VALUES (03,'Pradeep', 'Natani', 30000)")
c.execute("INSERT INTO employee1s VALUES (04,'Kunal', 'Vaid', 30000)")
c.execute("INSERT INTO employee1s VALUES (05,'Devendra', 'Shekhawat', 30000)")


# STEP 3
c.execute("SELECT * FROM employee1s")
